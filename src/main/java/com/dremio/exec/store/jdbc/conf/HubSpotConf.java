...
@SourceType(value = "HubSpotARP", label = "HubSpot",uiConfig = "hubspot-layout.json")
public class HubSpotConf extends AbstractArpConf<HubSpotConf> {
  private static final String ARP_FILENAME = "arp/implementation/hubspot-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.hubspot.HubSpotDriver";
